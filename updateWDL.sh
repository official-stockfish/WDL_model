...
python scoreWDL.py updateWDL.json --plot save --pgnName updateWDL.png --yData "move" --yDataTarget 32 --moveMin 8 --moveMax 120 --modelFitting optimizeProbability --NormalizeToPawnValue $oldpawn >&scoreWDL.log
