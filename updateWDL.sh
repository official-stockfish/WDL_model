...
python scoreWDL.py updateWDL.json --plot save --pgnName updateWDL.png --yDataTarget 32 --yDataMin 4 --yDataMax 120 --yPlotMin 10 --modelFitting optimizeProbability --NormalizeToPawnValue $oldpawn >&scoreWDL.log
